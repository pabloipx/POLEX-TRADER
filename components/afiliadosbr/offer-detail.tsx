...
const RULE_SECTIONS = [
  {
    ...
    body: [
      "• Não se apresente como um funcionário/representante da Fidex Option ou as suas fontes de tráfego como perfis oficiais da Fidex Option em redes sociais ou websites. Suas fontes de tráfego não devem induzir ao erro, fazendo crer que são oficiais, e não devem ser semelhantes aos websites e/ou perfis de redes sociais oficiais da Fidex Option. Se você utilizar um website para a promoção da Fidex Option, ele não deve conter a marca Fidex Option em seu nome e deve ser claramente identificado como não oficial na primeira tela.",
      "• Não faça login na conta da Fidex Option do seu cliente e não realize operações em nome deles. Não é permitido operar em nome de outra pessoa para promover a corretora e criar conteúdo para fins de marketing. Você só pode operar estritamente na sua própria conta.",
      "• Não compre publicidade usando o link de afiliado e não dê lances para consultas de marca da Fidex Option. Publicidade contextual de pesquisa e display só pode ser usada ao promover seus próprios websites.",
    ],
  },
  {
    id: "marketing",
  ...
  },
  {
    ...
    body: [
      "Ao rodar campanhas pagas, adicione como palavras negativas os termos de marca: Fidex Option, Fidex Option Broker, Fidex Option login, Fidex Option entrar, Fidex Option oficial, Fidex Option app e variações com erros de digitação.",
    ],
  },
  {
    id: "apps",
    ...
    body: [
      "Aplicativos próprios não podem usar o nome nem o logotipo da Fidex Option como identidade principal, devem informar de forma visível que não são oficiais e precisam de aprovação prévia do gerente antes da publicação nas lojas.",
    ],
  },
  {
    id: "regras",
      ...
      {tab === "Anunciante" && (
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          <article className="flex flex-col gap-5 rounded-xl border border-gray-200 p-6 text-[15px] leading-relaxed text-gray-700">
            <p>Fidex Option — A mais simples, completa e lucrativa plataforma de trading.</p>
            <p>
